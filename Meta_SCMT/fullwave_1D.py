...
class Fullwave_1D():
    ...
    def init_sim(self, prop_dis: float, N: int, hs: float, res: Optional[int] = None, theta: float = 0, empty: bool = False, backend: str = 'meep', vis_path: Optional[str] = None) -> None:
    ...
    def meep_init_sim(self, prop_dis: float, N: int, hs: float, res: Optional[int] = None, theta: float = 0, empty: bool = False) -> None:
        '''
        input:
            theta: [rad]
        '''
    ...
    def tidy3d_init_sim(self, prop_dis: float, N: int, hs: float, res: Optional[int] = None, theta: float = 0, empty: bool = False) -> None:
        # tidy3D import
        import tidy3d as td
        warnings.warn(
        ...
        # x-z plane monitor.
        monitor_xz = td.FreqMonitor(center=[0, 0, 0], size=[
        ...
        self.sim = td.Simulation(size=sim_size,
                                 ...
                                 monitors=[monitor_xz, monitor_in, monitor_near,
                                           monitor_far, monitor_focus, monitor_back],
                                 run_time=run_time,
